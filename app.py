...
def process_df(df):
    ...
    df = df[['topic_number', 'closing_date', 'title', 'text', 'url', 'text_embedded', '2grams']]
    return df
...
if st.session_state['button1'] and uploaded_file is not None and st.session_state['download_csv'] == False:
    ...
    for index, row in dataframe.iterrows():
        ...
        temp_df = (grants
                    .assign(
                        jaccard_bigram=grants['2grams'].apply(lambda x: modified_jaccard(x, bigrams)),
